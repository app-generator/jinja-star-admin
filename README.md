...
Jinja Template project generated by AppSeed on top of a modern UI Kit. **Star Admin 2** is an open-source Bootstrap 5 dashboard template provided by BootstrapDash. 
The project can be used as a codebase for future project or to migrate the Jinja files and assets to a legacy Python-based project that uses Jinja as template engine (Flask, Bottle, Django). 
...
- [LIVE Demo](https://jinja-star-admin.appseed-srv1.com/) - starter in action
...
---
Jinja Star Admin - Provided by **AppSeed** [App Generator](https://appseed.us/app-generator).
